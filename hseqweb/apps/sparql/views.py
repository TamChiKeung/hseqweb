...
from hseqweb.apps.sparql.example import LIST_SUBMISSION_EXAMPLE, LIST_SARS_COV_SUBMISSION_EXAMPLE, GET_SUBMISSION_BY_URI_EXAMPLE
from hseqweb.apps.sparql.forms import SparqlForm
