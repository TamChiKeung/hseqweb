"""
Django settings for hseqweb project.
...
configFile = config_dir + "/hseqweb.ini"

if not os.path.isfile(configFile):
    os.makedirs(config_dir, exist_ok=True)
    shutil.copyfile("default_hseqweb.ini", configFile)
...
WSGI_APPLICATION = 'hseqweb.wsgi.application'
